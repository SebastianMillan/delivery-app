INSERT INTO category(id,name,description) VALUES (1,'Bebida','Refrescante');
INSERT INTO category(id,name,description) VALUES (2,'Entrantes','Entremeses');
INSERT INTO category(id,name,description) VALUES (3,'Carnes','Ibérica española');
INSERT INTO category(id,name,description) VALUES (4,'Pescados','Fresco y de temporada');
INSERT INTO category(id,name,description) VALUES (5,'Postre','Artesanos');
